...
def upgrade():
    ...
    with op.batch_alter_table('block_transaction', schema=None) as batch_op:
        batch_op.create_index('ix_block_transaction_transaction_id', ['transaction_id'], unique=False)
    ...
    with op.batch_alter_table('inflow', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_inflow_transaction_id', ['transaction_id'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('submission', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_submission_transactor_address'))
        batch_op.drop_index(batch_op.f('ix_submission_txid'))

    op.drop_table('submission')
    op.drop_table('pending_ioflow')
    with op.batch_alter_table('inflow', schema=None) as batch_op:
        batch_op.drop_index('ix_inflow_transaction_id')
    ...
    op.drop_table('chain')
    with op.batch_alter_table('block_transaction', schema=None) as batch_op:
        batch_op.drop_index('ix_block_transaction_transaction_id')
