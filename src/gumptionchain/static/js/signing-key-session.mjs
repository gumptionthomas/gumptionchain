// Shared per-page signing_key session + auto-lock policy. An unlocked SigningKey lives
...
//
// The signing_key is dropped — best-effort lock — on:
//   - a manual lock(),
