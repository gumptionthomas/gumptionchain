// Typed errors shared by the signing_key storage orchestration (gc-store) and the
...
// Backup artifact is not a recognizable gc-signing-key-backup, has an unknown
